...
default_tickers = ["QQQ","SPY","NVDA","MU", "AVGO","TSLA","AMD","MRVL","uber","AMZN","AAPL","googl","META","SMCI","MARA","nke","GM","c","wfc","hood","coin","bac","jpm","HIMS","TXM","QCOM","MU","INTC","CRDO","RMBS","ON","ORCL", "CRWD","PANW","APP","MSTR","IBM","AMAT","DELL","WDC","CRM","CHWY","ETSY","CART","W"]
