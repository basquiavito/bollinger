...
# # #*******************************************************************************************************************************************************************************
                ...
                fig.add_trace(go.Scatter(x=intraday['TimeIndex'], y=intraday['MIDAS_Bear'], name="MIDAS Bear", line=dict(color="#E39F59", dash="solid", width=1)))
                fig.add_trace(go.Scatter(x=intraday['TimeIndex'], y=intraday['MIDAS_Bull'], name="MIDAS Bull",line=dict(color="#E39F59", dash="solid", width=1)))
                fig.update_layout(
