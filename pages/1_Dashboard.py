...
#                 fig.add_trace(up_high_trace, row=1, col=1)
                ...
                fig.add_trace(go.Scatter(
                    ...
                    y=intraday.loc[first_entry_mask, "F_numeric"] - 8,
                    mode="text",
                ...
                fig.add_trace(go.Scatter(
                    ...
                    y=intraday.loc[second_entry_mask, "F_numeric"] - 8,
                    mode="text",
                ...
                fig.add_trace(go.Scatter(
                    ...
                    y=intraday.loc[call1_mask, "F_numeric"] + 8,
                    mode="text",
                ...
                fig.add_trace(go.Scatter(
                    ...
                    y=intraday.loc[call2_mask, "F_numeric"] + 8,
                    mode="text",
                ...
                fig.add_trace(go.Scatter(
                    ...
                    y=intraday.loc[call3_mask, "F_numeric"] + 8,
                    mode="text",
