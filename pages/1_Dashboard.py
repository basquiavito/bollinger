...
default_tickers = ["SPY","QQQ","NVDA","MSFT","MU", "AVGO","TSLA","AMD","PLTR","MRVL","uber","AMZN","AAPL","googl","META","MARA","nke","GM","c","wfc","hood","coin","bac","jpm","HIMS","TXM","QCOM","MU","INTC","CRDO","RMBS","ON","ORCL", "CRWD","PANW","APP","MSTR","IBM","AMAT","DELL","WDC","CRM","CHWY","ETSY","CART","W"]
