...
#                 # fig.add_trace(up_high_trace, row=1, col=1)
    ...
    try:
        # --- Filter data for this ticker and sort ---
        ...
        with st.expander(f"🕯️ {t} — Candles + Ichimoku + BB + Volume", expanded=True):
            ...
            # Ichimoku lines (skip hover noise)
            ...
            # --- Volume (bottom pane) with RVOL in hover only ---
