...
default_tickers = ["SPY","VIXY","SOXX","NVDA","AMZN","MU","AMD","QCOM","SMCI","MSFT", "AVGO","TSLA","MRVL","QQQ","PLTR","AAPL","GOOGL","META","XLY","TSLA","nke","GM","c","DKNG","CHWY","ETSY","CART","W","KBE","wfc","hood","PYPL","coin","bac","jpm","BTC-USD","ETH-USD","XRP-USD","ADA-USD","SOL-USD","DOGE-USD"]
