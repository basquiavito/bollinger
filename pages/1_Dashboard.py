...
default_tickers = ["SPY","VIXY","SOXX","NVDA","AMZN","MU","NQ=F","AMD","QCOM","SMCI","MSFT", "AVGO","MRVL","QQQ","PLTR","AAPL","GOOGL","META","XLY","TSLA","nke","GM","c","DKNG","CHWY","ETSY","CART","W","KBE","wfc","hood","PYPL","coin","bac","jpm","BTC-USD","ETH-USD","XRP-USD","ADA-USD","SOL-USD","DOGE-USD"]
...
#                     # Add to figure
   ...
   #                      st.markdown("🟠 **Open Outside Range but NOT Accepted (possible fade or retest)**")
                ...
                fig.update_layout(
                    ...
                    height=3000,  # Increase overall figure height (default ~450-600)
                    showlegend=True,
