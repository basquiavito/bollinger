...
default_tickers = ["SPY","VIXY","SOXX","NVDA","AMZN","MU","AMD","SMCI","MSFT", "AVGO","QCOM","TSLA","MRVL","QQQ","uber","PLTR","AAPL","GOOGL","META","XLY","TSLA","nke","GM","c","DKNG","CHWY","ETSY","CART","W","KBE","wfc","hood","PYPL","coin","bac","jpm","BTC-USD","ETH-USD","XRP-USD","ADA-USD","SOL-USD","DOGE-USD"]
...
#**************************************************************************************************************************************************************************
                   ...
                   # Calculate Chikou (lagging span) using Close price shifted BACKWARD
                    ...
                    upper_band = go.Scatter(
                        ...
                        y=intraday["F% Upper"],
                        mode="lines",
                        line=dict(dash="solid", color="#d3d3d3",width=4.2),
                        name="Upper Band"
                    )
