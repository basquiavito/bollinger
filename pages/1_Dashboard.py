...
# 3) Now that intraday is fully processed,
                ...
                with st.expander("Show/Hide Data Table",  expanded=False):
                    ...
                    cols_to_show = [
                                    "Time","Volume","F_numeric","RVOL_5","RVOL_Alert","BBW_Tight_Emoji","BBW Alert","wing_emoji","bat_emoji","Marengo","South_Marengo","Upper Angle","Lower Angle","signed_vol_z","tdSupplyCrossalert", "Kijun_F_Cross","ADX_Alert","STD_Alert","ATR_Exp_Alert","Tenkan_Kijun_Cross","Dollar_Move_From_F","Call_Return_%","Put_Return_%","Call_Option_Value","Tiger","Put_Option_Value","Call_Vol_Explosion","Put_Vol_Explosion","COV_Change","COV_Accel","Mike_Kijun_ATR_Emoji","Mike_Kijun_Horse_Emoji"    ]
...
# ✈️ Upward Crosses ABOVE Yesterday High
              ...
              # ➤ 🦇 Bat Emoji (-DI near Kijun down-cross)
                ...
                fig.add_trace(go.Scatter(
                    ...
                    y=intraday.loc[bat_mask, "F_numeric"] - 15,
                    mode="text",
