        ...
        with main_tabs[idx]:
            ...
            # Compute F% numeric (ensure this is the final calculation)
                ...
                def compute_option_value(df, premium=64, contracts=100):
                    ...
                    df["Vol_Explosion"] = df["Call_Option_Value"].diff().rolling(3).mean()
...
# 3) Now that intraday is fully processed,
                ...
                with st.expander("Show/Hide Data Table",  expanded=False):
                    ...
                    cols_to_show = [
                                    "Time","RVOL_5","RVOL_Alert","BBW_Tight_Emoji","BBW Alert","Marengo","South_Marengo","Upper Angle","Lower Angle","tdSupplyCrossalert", "Kijun_F_Cross","ADX_Alert","STD_Alert","ATR_Exp_Alert","Tenkan_Kijun_Cross","Dollar_Move_From_F","Call_Return_%","Put_Return_%","Call_Option_Value","Put_Option_Value","Vol_Explosion"
                                ]
