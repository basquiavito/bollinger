...
default_tickers = ["SPY","QQQ","NVDA","TSLA","SMCI", "AVGO","AMD","PLTR","MRVL","uber","AMZN","AAPL","googl","META","MSFT","MARA","nke","GM","c","wfc","hood","coin","bac","jpm"]
...
# # ------------------------------------------------------------------------------------------------------------------------
                    ...
                    scatter_tk_sun = go.Scatter(
                        ...
                        y=intraday.loc[mask_tk_sun, "F_numeric"] + 100,  # Offset for visibility
                        mode="text",
                        text="🌞",
                        textposition="top center",
                        textfont=dict(size=34),
                    ...
                    scatter_tk_moon = go.Scatter(
                        ...
                        y=intraday.loc[mask_tk_moon, "F_numeric"] - 100,  # Offset for visibility
                        mode="text",
                        text="🌙",
                        textposition="bottom center",
                        textfont=dict(size=34),
